                ...
                <!-- category -->
                                      ...
                                      if ($category['parent_id'] == null) { ?>
                                          <li>
                                              <div class="flex w-full items-center gap-x-2 pr-4 bg-gray-50 rounded-md">
                                                  <input id="c<?= $category['id'] ?>" type="checkbox" value="<?= $category['id'] ?>" class="h-4 w-4 cursor-pointer rounded-xl border-gray-300 bg-gray-100">
                                                  <label for="c<?= $category['id'] ?>" class="w-full cursor-pointer py-2 pl-4 text-zinc-600">
                  ...
                  <li>
                      <details class="group border rounded-md">
                          ...
                          <div class="mt-2 max-h-60 overflow-y-auto px-2 pb-2">
                              <!-- این لیست از طریق Ajax به‌روز می‌شود -->
