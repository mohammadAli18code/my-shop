        ...
        <div class="main-content font-size-13">
            <div class="tab__box">
                <div class="tab__items">
                    ...
                    <a class="tab__item is-active" href="<?= url('admin/users/admins') ?>">مدیران</a>
                ...
                <table class="table">
                    ...
                    <?php
                        foreach($admins as $admin){
                            ...
                            <td><img class="profile-pic" src="<?= asset($admin['image']) ?>" alt=""></td>
                            ...
                            <?php }else if($admin['is_active'] == 2){ ?>
                            <td class="text-success">تایید شده</td>
                            <?php } ?>
                            <td>
                                <a href="<?= url('admin/admins/delete/' . $admin['id']) ?>" class="item-delete mlg-15" title="حذف"></a>
                                <a href=" <?= url('admin/admins/confirm/' . $admin['id']) ?>" class="item-confirm mlg-15" title="تایید"></a>
                                <a href="<?= url('admin/admins/not-confirm/' . $admin['id']) ?>" class="item-reject mlg-15" title="رد"></a>
                                <a href="edit-user.html" target="_blank" class="item-eye mlg-15" title="مشاهده"></a>
                                <a href="<?= url('admin/profile/admin/edit/' . $admin['id']) ?>" class="item-edit " title="ویرایش"></a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
