      ...
      <div class="text-center font-semibold text-lg md:text-xl text-zinc-700">
        ...
        <ul class="px-5 py-3 space-y-1">
          ...
          <li class="px-3 py-2 group flex gap-x-2 group items-center">
            ...
            <a class="flex gap-x-1 items-center text-sky-700 my-1 w-full" href="<?= url('customer/profile-messages') ?>">
        ...
        <div>
          ...
          <div class="space-y-5">
            <div class="bg-zinc-100 rounded-md">
              <div class="border-b border-b-zinc-500 px-3 py-2 text-zinc-800 text-sm font-semibold flex justify-between items-center">
                تایید نظر
                <a href="" class="text-zinc-50 hover:text-zinc-100 transition bg-sky-500 px-3 py-1 text-xs rounded-md">
                  بهمن 1402
                 </a>
              </div>
