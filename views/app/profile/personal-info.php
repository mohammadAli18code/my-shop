  ...
  <main class="pt-24 md:pt-36 max-w-[1600px] mx-auto px-3 md:px-6">
      ...
      <div class="text-center font-semibold text-lg md:text-xl text-zinc-700">
        ...
        <ul class="px-5 py-3 space-y-1">
          ...
          <li class="px-3 py-2 group flex gap-x-2 group items-center">
            ...
            <a class="flex gap-x-1 items-center text-sky-700 my-1 w-full" href="<?= url('customer/profile-personal-info') ?>">
    ...
    <form action="<?= url('customer/profile/update') ?>" method="POST" enctype="multipart/form-data">
      <div>
          <!-- inputs -->
        <?php
          $message = flash('change_info_result');
          if(!empty($message)){
        ?>
        ...
        <?php } ?>
          <div class="sm:flex gap-x-5 mt-5">
            <div class="sm:w-1/2 mb-2 sm:mb-0 flex flex-col gap-y-1">
              ...
              <input type="text" name="first_name" value="<?= $_SESSION['customerInfo']['first_name'] ?>" class="focus:shadow-primary-outline text-sm leading-5.6 block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-sky-300 focus:outline-none">
            </div>
            <div class="sm:w-1/2 flex flex-col gap-y-1">
              ...
              <input type="text" name="last_name" value="<?= $_SESSION['customerInfo']['last_name'] ?>" class="focus:shadow-primary-outline text-sm leading-5.6 block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-sky-300 focus:outline-none">          
            </div>
          </div>
          <div class="sm:flex gap-x-5 mt-5">
            <div class="sm:w-1/2 mb-2 sm:mb-0 flex flex-col gap-y-1">
            ...
            <div class="sm:w-1/2 mb-2 sm:mb-0 flex flex-col gap-y-1">
              ...
              <input type="text" name="email" value="<?= $_SESSION['customerInfo']['email'] ?>" class="focus:shadow-primary-outline text-sm leading-5.6 block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-sky-300 focus:outline-none">
            </div>
          </div>
          <div class="sm:flex gap-x-5 mt-5">
            <div class="sm:w-1/2 mb-2 sm:mb-0 flex flex-col gap-y-1">
              ...
              <input type="text" name="address" value="<?= $_SESSION['customerInfo']['address'] ?>" class="focus:shadow-primary-outline text-sm leading-5.6 block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-sky-300 focus:outline-none">
            </div>
            <div class="sm:w-1/2 mb-2 sm:mb-0 flex flex-col gap-y-1">
              <label class="text-sm text-zinc-700 flex">
                جنسیت
              ...
              <select name="" class="focus:shadow-primary-outline text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-sky-500 focus:outline-none">
                <option value="">-</option>
          ...
          <div class="sm:flex gap-x-5 mt-5">
            <div class="sm:w-1/2 mb-2 sm:mb-0 flex flex-col gap-y-1">
              ...
              <input type="text" name="country" value="<?= $_SESSION['customerInfo']['country'] ?>" class="focus:shadow-primary-outline text-sm leading-5.6 block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-sky-300 focus:outline-none">
            </div>
            <div class="sm:w-1/2 flex flex-col gap-y-1">
              <label class="text-sm text-zinc-700 flex">
                شهر(استان)
              ...
              <input type="text" name="city" value="<?= $_SESSION['customerInfo']['city'] ?>" class="focus:shadow-primary-outline text-sm leading-5.6 block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-sky-300 focus:outline-none">          
            </div>
          </div>
          <div class="sm:flex gap-x-5 mt-5">
            <div class="sm:w-1/2 mb-2 sm:mb-0 flex flex-col gap-y-1">
              ...
              <input type="password" name="password" value="<?= $_SESSION['customerInfo']['password'] ?>" class="focus:shadow-primary-outline text-sm leading-5.6 block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-sky-300 focus:outline-none" disabled>
            </div>
            <div class="sm:w-1/2 flex flex-col gap-y-1">
              <label class="text-sm text-zinc-700 flex">
                وضعیت حساب
              ...
              <input type="text" name="status" value="<?php if($_SESSION['customerInfo']['is_active'] == 2){echo 'فعال' ;}else{ echo 'غیر فعال';} ?>" class="focus:shadow-primary-outline text-sm leading-5.6 block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all focus:border-sky-300 focus:outline-none" disabled>          
            </div>
          </div>
          <div class="sm:flex items-center gap-x-5 mt-5">
            ...
            <div class="sm:w-1/2 flex gap-x-2 justify-center items-center pt-7 h-16">
              ...
              <label for="dropzone-file" class="w-8/12 sm:w-1/3 flex flex-col items-center justify-center border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                ...
                <input id="dropzone-file" name="image" type="file" class="hidden" value="<?= $_SESSION['customerInfo']['image'] ?>">
              </label>
            </div>
          </div>
          <button class="mx-auto w-1/3 px-2 py-3 mt-8 text-sm bg-gradient-to-bl from-sky-500 to-sky-600 hover:opacity-80 transition text-gray-100 rounded-lg">
            ثبت اطلاعات
          </button>
        </div>
      </form>
