    ...
    ?>
        ...
        <div class="main-content  ">
            <div class="user-info bg-white padding-30 font-size-13">
                <form action="<?= url('admin/profile/update/customer/' . $customers['id']) ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <input class="text" name="first_name" placeholder="نام" value="<?= $customers['first_name'] ?>">
                    <input class="text text-right"  name="last_name"    placeholder="نام خانوادگی"  value="<?= $customers['last_name'] ?>">
                    <input class="text text-right"  name="age"          placeholder="سن"             value="<?= $customers['age'] . ' سال' ?>">
                    <input class="text text-right"  name="email"        placeholder="ایمیل"          value="<?= $customers['email'] ?>">
                    <input class="text text-right"  name="phone_number" placeholder="شماره موبایل"  value="<?= $customers['phone_number'] ?>">
                    ...
                    <input class="text text-right"  name="address"      placeholder="آدرس"           value="<?= $customers['address'] ?>">
                    <!-- <p class="input-help text-left margin-bottom-12" dir="ltr">
                        
                        <a href="https//netcopy/tutors/"></a>
                    </p> -->
                    <input style="pointer-events:none" name="password" class="text text-right" type="password" placeholder="رمز عبور" value="<?= $customers['password'] ?>">
